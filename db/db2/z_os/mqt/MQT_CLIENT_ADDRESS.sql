...
CREATE INDEX CWSRS1.MQTCLPP ON CWSRS1.MQT_CLIENT_ADDRESS (CLT_IDENTIFIER ASC, CLT_SENSTV_IND ASC) 
USING STOGROUP SMSSG000 -- changes by schema and database
PRIQTY -1 SECQTY -1 
FREEPAGE 0 PCTFREE 5 
GBPCACHE CHANGED 
CLUSTER 
COMPRESS NO 
BUFFERPOOL BP8 -- changes by schema and database
CLOSE NO 
COPY NO 
DEFER NO 
DEFINE YES; 
