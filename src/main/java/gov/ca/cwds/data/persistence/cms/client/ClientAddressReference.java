...
public class ClientAddressReference extends ClientReference {
  ...
  protected enum ColumnPosition {
    START, CLT_IDENTIFIER, CLA_IDENTIFIER, CLA_LST_UPD_ID, CLA_LST_UPD_TS, CLA_ADDR_TPC,
    // CLA_BK_INMT_ID,
    CLA_EFF_END_DT, CLA_EFF_STRTDT, CLA_FKADDRS_T, CLA_FKCLIENT_T,
    // CLA_FKREFERL_T,
    // CLA_HOMLES_IND,
    CLA_IBMSNAP_LOGMARKER, CLA_IBMSNAP_OPERATION
  }
